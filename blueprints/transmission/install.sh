...
createmount "$1" "${global_dataset_downloads}" /mnt/bunzdata/downloads

# Check if dataset Complete Downloads dataset exist, create if they do not.
createmount "$1" "${global_dataset_downloads}"/complete /mnt/bunzdata/downloads/complete

# Check if dataset InComplete Downloads dataset exist, create if they do not.
createmount "$1" "${global_dataset_downloads}"/incomplete /mnt/bunzdata/downloads/incomplete
...
iocage exec "$1" sysrc "transmission_download_dir=/mnt/bunzdata/downloads/complete"
